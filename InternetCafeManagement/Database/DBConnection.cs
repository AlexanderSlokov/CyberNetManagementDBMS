...
namespace InternetCafeManagement.Database
{
    class DBConnection
    {
        private const string connectionString = "Data Source=MAYTINH-0ANFSS5;Initial Catalog=InternetCafe;Integrated Security=True";
        private string role;
        ...
        private SqlConnection con = new SqlConnection(@"Data Source=MAYTINH-0ANFSS5;Initial Catalog=InternetCafe;Integrated Security=True");

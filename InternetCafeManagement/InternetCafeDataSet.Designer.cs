...
namespace InternetCafeManagement {
    ...
    public partial class InternetCafeDataSet : global::System.Data.DataSet {
        ...
        public partial class accountDataTable : global::System.Data.TypedTableBase<accountRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public accountRow AddaccountRow(int Id, string name, string phone, string email, string username, string password) {
...
namespace InternetCafeManagement.InternetCafeDataSetTableAdapters {
    ...
    public partial class accountTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[account] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[account] ([Id], [name], [phone], [email], [username], [passwor" +
                "d]) VALUES (@Id, @name, @phone, @email, @username, @password);\r\nSELECT Id, name," +
                " phone, email, username, password FROM account WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[account] SET [Id] = @Id, [name] = @name, [phone] = @phone, [email] = @email, [username] = @username, [password] = @password WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)));
SELECT Id, name, phone, email, username, password FROM account WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::InternetCafeManagement.Properties.Settings.Default.InternetCafeConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, phone, email, username, password FROM dbo.account";
        ...
        public virtual int Fill(InternetCafeDataSet.accountDataTable dataTable) {
        ...
        public virtual InternetCafeDataSet.accountDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            InternetCafeDataSet.accountDataTable dataTable = new InternetCafeDataSet.accountDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(InternetCafeDataSet.accountDataTable dataTable) {
        ...
        public virtual int Insert(int Id, string name, string phone, string email, string username, string password) {
        ...
        public virtual int Update(int Id, string name, string phone, string email, string username, string password, int Original_Id, string Original_name, string Original_phone, string Original_email, string Original_username, string Original_password) {
        ...
        public virtual int Update(string name, string phone, string email, string username, string password, int Original_Id, string Original_name, string Original_phone, string Original_email, string Original_username, string Original_password) {
            return this.Update(Original_Id, name, phone, email, username, password, Original_Id, Original_name, Original_phone, Original_email, Original_username, Original_password);
        }
    }
